namespace ClassAnalytics.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ClassAnalytics.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ClassAnalytics.Models.ApplicationDbContext context)
        {
            ...
            //    new TaskModel { taskType_Id = 1, taskName = "Python test", startDate = Convert.ToDateTime("06/12/2017"), endDate = Convert.ToDateTime("06/12/2017"), points = 40, course_Id = 1, taskNotes = "a test" },
            //    new TaskModel { taskType_Id = 2, taskName = "Binary Search Tree", startDate = Convert.ToDateTime("06/07/2017"), endDate = Convert.ToDateTime("06/09/2017"), points = 30, course_Id = 1, taskNotes = "" },
            //    new TaskModel { taskType_Id = 3, taskName = "Lemonade Stand", startDate = Convert.ToDateTime("06/09/2017"), endDate = Convert.ToDateTime("06/12/2017"), points = 30, course_Id = 2, taskNotes = "" }
            //    );
            ...
            //    new SurveyModel { SurveyName = "JavaScript Progress", course_Id = 3 }
            //);
            ...
            //    new SurveyQuestion { question = "Question 1", survey_Id = 3 },
            //    new SurveyQuestion { question = "Question 2", survey_Id = 3 },
            //    new SurveyQuestion { question = "Question 4", survey_Id = 3 },
            //    new SurveyQuestion { question = "Question 4", survey_Id = 3 },
            //    new SurveyQuestion { question = "Question 5", survey_Id = 3 }
            //    );
            ...
            //    new SurveyJoinTableModel { class_Id = 3, survey_Id = 3, active = false },
            //    new SurveyJoinTableModel { class_Id = 4, survey_Id = 1, active = false },
            //    new SurveyJoinTableModel { class_Id = 5, survey_Id = 2, active = false }
            //    );
        }
    }
}
